 ...
 */
const CASITA_OVERRIDE = new Set(['', 'proyectos', 'conexiones', 'impacto', 'centro-control']);
...
export const GALI_V5_V2_CHILD_ROUTES: Routes = [
  ...
  {
    // Host experto: agrupa Agentes/Skills/Reglas/Marketplace (la maquinaria de Gali).
    path: 'centro-control',
    loadComponent: () =>
      import('./centro-control/centro-control.component').then(m => m.CentroControlComponent),
  },
