...
export class CentroControlComponent {
  readonly cards: ControlCard[] = [
    { glyph: '✶', titulo: 'Agentes', desc: 'Roax, Vigilante, Chatea Pro, ADA Spy y Kronos. Cada uno se especializa en un área y reporta lo que hace.', route: '/gali-v5-v2/centro-control/agentes', cta: 'Ver agentes' },
    { glyph: '⚡', titulo: 'Skills', desc: 'Capacidades reutilizables que tus agentes pueden usar. Como herramientas en una caja.', route: '/gali-v5-v2/centro-control/skills', cta: 'Ver skills' },
    { glyph: '⊞', titulo: 'Reglas', desc: 'Instrucciones en lenguaje natural que limitan cuándo y cómo actúa cada agente.', route: '/gali-v5-v2/centro-control/reglas', cta: 'Ver reglas' },
    { glyph: '⊕', titulo: 'Marketplace', desc: 'Skills y plantillas de la comunidad de dropshippers. Instala lo que ya le funciona a otros.', route: '/gali-v5-v2/centro-control/marketplace', cta: 'Explorar' },
  ];
}
